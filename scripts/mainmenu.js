...
var MainMenu = ( function() {
	...
	var d_IsVacBanned = false;
	var d_IsOutOfDate = false;
	var d_IsCompCooldown = false;
	var d_IsTempCooldown = false;
	var d_IsOverwatch = false;
	var d_IsLegacy = false;
	var d_IsOffline = false;
	...
	var _BetaEnrollmentStatusChange = function ()
	{
		...
		let bShowEnrollIntoBetaButton = true;
	...
	var _OnShowPauseMenu = function()
	{
		...
		var bIsCommunityServer = false;

		                                                                        
		                                                                                                         
		$( '#MainMenuNavBarPlay' ).SetHasClass( 'mainmenu-navbar__btn-small--hidden', true );

		$( '#MainMenuNavBarSwitchTeams' ).SetHasClass( 'mainmenu-navbar__btn-small--hidden', ( true ) );
	...
	function _GetNotificationBarData()
	{
		...
		if ( LicenseUtil.GetCurrentLicenseRestrictions() === false || d_IsOffline)
		{
